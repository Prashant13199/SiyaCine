    ...
    return (
        <div key={datas?.id} id={`${seasonNumber}${datas?.episode_number}`} className={datas?.air_date <= getCurrentDate() ? 'single_episode' : 'single_episode_fade'}>
            ...
            <div className='relative' onClick={() => {
                ...
                <img loading='lazy' alt="" src={datas.still_path ? `https://image.tmdb.org/t/p/w342/${datas.still_path}` : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZloANkq34iji2rYsX6MRnvKxRauEujYNJ3_WlwOeWSksm7XJBTmHwOJg6pdcsDFUeG3M&usqp=CAU"} className='single_episode_image' />
            </div>
