...
export default function Notification({ noti, handleClose }) {
    ...
    return (
        <>
            <div className='notification'>
                ...
                <div className='notification_right'>
                    ...
                    <div className='notification_btns'>
                        ...
                        {noti?.comment && <div onClick={() => setShow(!show)} className='notification_delete'>note&nbsp;&nbsp;</div>}
            ...
            {show && <div className='noti_comment'>
                <div>
                    <span className='suggestionNoteText'>Note:</span> {noti?.comment}
                </div>
                <div onClick={() => setShow(!show)} className='notification_delete'>{'close'}</div>
            </div>}
        </>
    )
}
