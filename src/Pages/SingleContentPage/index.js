    ...
    <>
      ...
      <Modal show={show4} onHide={handleClose4} fullscreen>
        <Modal.Body style={{ backgroundColor: theme.palette.background.default }}>
          ...
          {server === 4 && <iframe title={data?.name || data?.title || data?.original_name} allowFullScreen scrolling="no" style={{ width: "100%", height: window.innerHeight - 85 }} src={`https://vidsrc.sbs/embed/movie/${id}?t=${currentTime}?color=ffa726`}></iframe>}
